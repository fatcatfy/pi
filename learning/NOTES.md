...
- 仓库事实备忘：
  ...
  - `pi` bin → dist/bundle/cli.js，源码入口 PI/packages/coding-agent/src/cli.ts
  - PI/packages/ai/src/models.generated.ts 是生成文件，勿手改